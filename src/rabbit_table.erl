     ...
     {rabbit_topic_trie_binding,
      [{record_name, topic_trie_binding},
       ...
       {match, #topic_trie_binding{trie_binding = trie_binding_match(),
                                   _='_'}}]},
      {rabbit_headers_bindings_keys,
       [{record_name, headers_bindings_keys},
        {attributes, record_info(fields, headers_bindings_keys)},
        {type, bag},
        {match, #headers_bindings_keys{exchange = exchange_name_match(), _='_'}}]},
      {rabbit_headers_bindings,
